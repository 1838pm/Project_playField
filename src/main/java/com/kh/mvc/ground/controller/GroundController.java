...
import java.util.Map;import javax.management.modelmbean.ModelMBeanAttributeInfo;
...
//	private ResourceLoader resourceLoder;
	...
	public ModelAndView view(ModelAndView model, String g_no) {
		Ground ground = service.findByNo(g_no);
		System.out.println("ground : " + ground);
		
		model.addObject("ground", ground);
		model.setViewName("/search/searchView");
