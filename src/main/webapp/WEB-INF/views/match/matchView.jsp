    ...
    <main>
        <div id="slide">
            ...
            <ul>
              ...
              <li><a href=""><img src="${path}/resources/img/madeul_Stadium1.jpg" alt=""></a></li>
              <li><a href=""><img src="${path}/resources/img/madeul_Stadium.jpg" alt=""></a></li>
              <li><a href=""><img src="${path}/resources/img/madeul_Stadium.jpg" alt=""></a></li>
            </ul>
            <p class="pos">
                                    ...
                                    <div class="profile-cover rounded-top" data-background="" style="margin-bottom: -20px;">
                                        ...
                                        <div>
                                        	...
                                        	<select name="" id="" class="form-control">
                                                ...
                                                <option id="gk" value="GK">수비</option>
                                                <option id="gk" value="GK">골키퍼</option>
	                                        </select>
                                           
                                        </div>
                                        <button type="button" id="check_module" class="btn btn-primary">신청하기</button>
                                    </div>
