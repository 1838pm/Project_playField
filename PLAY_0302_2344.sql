...
CREATE TABLE PAYMENT(
    P_CODE VARCHAR2(100) PRIMARY KEY,
    P_DATE VARCHAR2(100),
    P_POINT VARCHAR2(100),
...
CREATE TABLE GROUND (
    ...
    G_END VARCHAR2(100),
    G_STATUS VARCHAR2(100) DEFAULT 'N',
    G_P_CODE VARCHAR2(100),
    CONSTRAINT FK_GROUND_CODE FOREIGN KEY(G_P_CODE) REFERENCES PAYMENT(P_CODE) ON DELETE SET NULL
);
...
UPDATE GROUND SET G_STATUS = 'Y' WHERE G_NO = 'S220214104838997992';
...
SELECT G_NO,
       ...
       G_END
FROM GROUND
WHERE G_NO = 'S220214104838997992';
