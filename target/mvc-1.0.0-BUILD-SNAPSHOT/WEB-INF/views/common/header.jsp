...
<body>
    <header class="header-global">
        ...
        <div class="container">
                ...
                <ul class="navbar-nav navbar-nav-hover justify-content-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="supportDropdown">
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    <a href="${path}/search/searchList" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        <span class="icon icon-md icon-secondary"><i class="fas fa-file-alt"></i></span>
                                        <div class="ml-4">
                                            <span class="text-dark d-block">구장 조회<span class="badge badge-sm badge-secondary ml-2"></span></span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="supportDropdown">
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    <a href="${path}/match/matchList" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        <span class="icon icon-md icon-secondary"><i class="fas fa-file-alt"></i></span>
                                        <div class="ml-4">
                                            <span class="text-dark d-block">매치 조회<span class="badge badge-sm badge-secondary ml-2"></span></span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="supportDropdown">
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    <a href="${path}/board/boardList" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        <span class="icon icon-md icon-primary"><i class="fas fa-file-alt"></i></span>
                                        <div class="ml-4">
                                            <span class="text-dark d-block">자유 게시판</span>
                                        </div>
                                    </a>
                                </div>
                            </div>
            ...
            <c:if test="${loginMember != null}">
	            <div class="d-none d-lg-block @@cta_button_classes" style="color: white; margin-right: 20px;">${loginMember.name}</div>
	            <button onclick="location.href='${path}/member/myPages1;'" class="btn btn-md btn-secondary animate-up-2" style="margin-right: 20px;">마이페이지</button>
	            <button onclick="location.replace('${path}/logout')" class="btn btn-md btn-outline-white animate-up-2 mr-3">로그아웃</button>
            </c:if>
