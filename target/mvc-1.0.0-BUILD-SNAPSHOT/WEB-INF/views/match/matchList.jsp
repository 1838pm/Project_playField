                ...
                <div class="col-12">
                    ...
                    <div class="card border-light mb-4 animate-up-5">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-1">
                                    <span class="h5 text-dark font-weight-bold">16:00</span>
                                </div>
                                <div class="col-sm-9">
                                    <span class="h5 text-dark font-weight-bold">마들 스타디움</span>
                                </div>
                                <div class="col-sm-2">
                                    <button type="button" class="btn btn-primary" onclick="location.href='${path}/match/matchView'">신청 가능</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card border-light mb-4 animate-up-5">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-1">
                                    <span class="h5 text-dark font-weight-bold">18:00</span>
                                </div>
                                <div class="col-sm-9">
                                    <span class="h5 text-dark font-weight-bold">마들 스타디움</span>
                                </div>
                                <div class="col-sm-2">
                                    <button type="button" class="btn btn-warning" onclick="location.href='${path}/match/matchView'">신청 임박</button>
                                </div>
                            </div>
                        </div>
                    </div>
